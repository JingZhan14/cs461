...
def connect():
    ...
    return mdb.connect(host="localhost",
                       user="jingz15",
                       passwd="b0905e63e9c83e2c9bbccf6f2242a7f194990d1b6ec03293935877e19ce45176",
                       db="project2");
...
def addHistory(user_id, query):
    ...
    sqlquery = 'INSERT INTO history (user_id,query) VALUES (%s,%s);'
    cur.execute(sqlquery,(user_id,query))
